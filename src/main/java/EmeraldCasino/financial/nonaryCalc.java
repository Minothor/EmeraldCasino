...
import EmeraldCasino.threadTest.main;
...
public class nonaryCalc {
	...
	public static int add(int value1, int value2){
		...
		temp = ((value1%10)+(value2%10))*offset;
		result+= (10*(temp/9))+(temp%9);
		value1/=10;
		value2/=10;
		offset*=10;
		}
	...
	public static void main(String[] args) {
		...
		System.out.println(""+val1+" + "+val2+" = "+nonaryCalc.add(val1, val2));
	}
